@extends('backend.layouts.master') {{-- Use frontend layout if exists --}}
                ...
                <div class="card profile-card">
                    ...
                    <div class="card-body avatar-container text-center">
                        @if($user->avatar && file_exists(public_path($user->avatar)))
                            <img src="{{ asset($user->avatar) }}" alt="Profile Picture" class="w-100 rounded-circle mb-3">
                        @else
                            <img src="{{ asset('frontend/img/default-avatar.png') }}" alt="Default Avatar" class="w-100 rounded-circle mb-3">
                        @endif
